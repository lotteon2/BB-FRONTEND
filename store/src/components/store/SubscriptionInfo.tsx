        ...
        <div>
          ...
          <div className="flex flex-row gap-3 mt-2">
            <div className="w-[200px] h-[200px]">
              <img src={data.productThumbnail} alt="상품 썸네일 이미지" />
            </div>
            <div className="flex flex-col gap-3 text-[1.2rem]">
              <p className="text-[2rem] font-bold">{data.productName}</p>
              <p className="text-grayscale5">{data.productSummary}</p>
          ...
          <div className="mt-2 h-40 overflow-auto">
            <img
              src={data.productDescriptionImage}
              alt="싱픔정보 상세"
              className="w-full"
            />
          </div>
