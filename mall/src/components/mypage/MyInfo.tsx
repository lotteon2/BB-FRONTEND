    ...
    <div className="w-full mx-auto flex flex-row gap-5 flex-wrap justify-between max-[660px]:justify-center">
      <div className="flex flex-row gap-3">
        ...
        <div className="flex flex-col gap-1">
          <p>꽃 선물하기 좋은 날이네요 {data.nickName}님!</p>
          <p className="text-grayscale5 text-[0.8rem]">{data.email}</p>
          <p className="text-grayscale5 text-[0.8rem]">{data.phoneNumber}</p>
      ...
      <div className="flex flex-row gap-3 text-[1rem] my-auto">
        <div className="text-center pt-2">
          <div>나의 쿠폰</div>
          <div className="font-bold">{data.couponCnt}개</div>
        </div>
