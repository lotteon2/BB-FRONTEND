    ...
    <div className="mt-10">
      <div className="w-full flex flex-row gap-2 flex-wrap">
        <div
          ...
          onClick={() => navigate("/product/tag/1")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/2")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/3")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/4")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/5")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/6")}
        >
        ...
        <div
          className="w-[12%] min-w-[80px] mx-auto flex flex-col bg-[#C2DE8A88] rounded-lg drop-shadow-md cursor-pointer hover:drop-shadow-none"
          onClick={() => navigate("/product/tag/7")}
        >
